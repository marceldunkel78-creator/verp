...
class TradingProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'supplier', 'supplier_name', 'category', 'category_display',
            'list_price', 'list_price_currency', 'exchange_rate', 'discount_percent',
            'price_valid_from', 'price_valid_until', 'markup_percent',
...
class TradingProductDetailSerializer(serializers.ModelSerializer):
    ...
    def get_price_breakdown(self, obj):
        ...
        return {
            ...
            'markup_percent': float(obj.markup_percent),
...
class TradingProductCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'supplier', 'category', 'description', 'unit',
            'list_price', 'list_price_currency', 'price_valid_from', 'price_valid_until',
