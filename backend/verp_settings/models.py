...
class ProductCategory(models.Model):
    ...
    def initialize_defaults(cls):
        ...
        defaults = [
            ...
            ('TIRF', 'TIRF', True, True, True, False, False, True),
            ('FRAP_TIRF', 'FRAP-TIRF', True, True, True, False, False, True),
            ...
            ('LICHTLEITER', 'Lichtleiter', True, True, True, False, False, True),
            ('MIKROSKOPADAPTER', 'Mikroskopadapter', True, True, True, False, False, True),
            ('HBO_XBO', 'HBO-XBO', True, True, True, False, False, True),
