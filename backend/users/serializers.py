...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'can_read_development', 'can_read_meetings', 'can_read_company_calendar',
            # Submodule - Lesen
            ...
            'can_read_sales_marketing', 'can_read_sales_tickets', 'can_read_sales_travel_reports',
            'can_read_sales_sql_projekte', 'can_read_sales_sql_angebote',
            ...
            'can_write_development', 'can_write_meetings', 'can_write_company_calendar',
            # Submodule - Schreiben
            ...
            'can_write_sales_marketing', 'can_write_sales_tickets', 'can_write_sales_travel_reports',
            'can_write_sales_sql_projekte', 'can_write_sales_sql_angebote',
