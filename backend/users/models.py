...
class User(AbstractUser):
    ...
    # Weitere Hauptmodule - Lesen
    can_read_finance = models.BooleanField(default=False, verbose_name='Finance - Lesen')
    can_read_procurement = models.BooleanField(default=False, verbose_name='Procurement - Lesen')
    can_read_inventory = models.BooleanField(default=False, verbose_name='Inventory - Lesen')
    can_read_visiview = models.BooleanField(default=False, verbose_name='VisiView - Lesen')
    can_read_bi = models.BooleanField(default=False, verbose_name='BI - Lesen')
    can_read_documents = models.BooleanField(default=False, verbose_name='Documents - Lesen')
    # Submodule - Lesen
    can_read_procurement_orders = models.BooleanField(default=False, verbose_name='Bestellungen - Lesen')
    can_read_procurement_loans = models.BooleanField(default=False, verbose_name='Leihgeräte - Lesen')
    can_read_procurement_product_collections = models.BooleanField(default=False, verbose_name='Produktsammlungen - Lesen')
    can_read_sales_dealers = models.BooleanField(default=False, verbose_name='Händler - Lesen')
    can_read_sales_pricelists = models.BooleanField(default=False, verbose_name='Preislisten - Lesen')
    can_read_sales_projects = models.BooleanField(default=False, verbose_name='Projekte - Lesen')
    can_read_sales_systems = models.BooleanField(default=False, verbose_name='Systeme - Lesen')
    can_read_sales_quotations = models.BooleanField(default=False, verbose_name='Angebote - Lesen')
    can_read_sales_order_processing = models.BooleanField(default=False, verbose_name='Auftragsbearbeitung - Lesen')
    can_read_sales_marketing = models.BooleanField(default=False, verbose_name='Marketing - Lesen')
    can_read_sales_tickets = models.BooleanField(default=False, verbose_name='Sales Tickets - Lesen')
    can_read_sales_travel_reports = models.BooleanField(default=False, verbose_name='Reise-/Serviceberichte - Lesen')
    can_read_sales_sql_projekte = models.BooleanField(default=False, verbose_name='SQL-Projekte - Lesen')
    can_read_sales_sql_angebote = models.BooleanField(default=False, verbose_name='SQL-Angebote - Lesen')
    can_read_manufacturing_vs_hardware = models.BooleanField(default=False, verbose_name='VS-Hardware - Lesen')
    can_read_manufacturing_production_orders = models.BooleanField(default=False, verbose_name='Fertigungsaufträge - Lesen')
    can_read_visiview_products = models.BooleanField(default=False, verbose_name='VisiView Produkte - Lesen')
    ...
    can_read_inventory_customer_loans = models.BooleanField(default=False, verbose_name='Verleihungen - Lesen')
    can_read_inventory_demo_systems = models.BooleanField(default=False, verbose_name='Demo-Systeme - Lesen')
    # Development Modul
    ...
    # Weitere Hauptmodule - Schreiben
    can_write_finance = models.BooleanField(default=False, verbose_name='Finance - Schreiben')
    can_write_procurement = models.BooleanField(default=False, verbose_name='Procurement - Schreiben')
    can_write_inventory = models.BooleanField(default=False, verbose_name='Inventory - Schreiben')
    can_write_visiview = models.BooleanField(default=False, verbose_name='VisiView - Schreiben')
    can_write_bi = models.BooleanField(default=False, verbose_name='BI - Schreiben')
    can_write_documents = models.BooleanField(default=False, verbose_name='Documents - Schreiben')
    # Submodule - Schreiben
    can_write_procurement_orders = models.BooleanField(default=False, verbose_name='Bestellungen - Schreiben')
    can_write_procurement_loans = models.BooleanField(default=False, verbose_name='Leihgeräte - Schreiben')
    can_write_procurement_product_collections = models.BooleanField(default=False, verbose_name='Produktsammlungen - Schreiben')
    can_write_sales_dealers = models.BooleanField(default=False, verbose_name='Händler - Schreiben')
    can_write_sales_pricelists = models.BooleanField(default=False, verbose_name='Preislisten - Schreiben')
    can_write_sales_projects = models.BooleanField(default=False, verbose_name='Projekte - Schreiben')
    can_write_sales_systems = models.BooleanField(default=False, verbose_name='Systeme - Schreiben')
    can_write_sales_quotations = models.BooleanField(default=False, verbose_name='Angebote - Schreiben')
    can_write_sales_order_processing = models.BooleanField(default=False, verbose_name='Auftragsbearbeitung - Schreiben')
    can_write_sales_marketing = models.BooleanField(default=False, verbose_name='Marketing - Schreiben')
    can_write_sales_tickets = models.BooleanField(default=False, verbose_name='Sales Tickets - Schreiben')
    can_write_sales_travel_reports = models.BooleanField(default=False, verbose_name='Reise-/Serviceberichte - Schreiben')
    can_write_sales_sql_projekte = models.BooleanField(default=False, verbose_name='SQL-Projekte - Schreiben')
    can_write_sales_sql_angebote = models.BooleanField(default=False, verbose_name='SQL-Angebote - Schreiben')
    can_write_manufacturing_vs_hardware = models.BooleanField(default=False, verbose_name='VS-Hardware - Schreiben')
    can_write_manufacturing_production_orders = models.BooleanField(default=False, verbose_name='Fertigungsaufträge - Schreiben')
    can_write_visiview_products = models.BooleanField(default=False, verbose_name='VisiView Produkte - Schreiben')
    ...
    can_write_inventory_customer_loans = models.BooleanField(default=False, verbose_name='Verleihungen - Schreiben')
    can_write_inventory_demo_systems = models.BooleanField(default=False, verbose_name='Demo-Systeme - Schreiben')
    # Development Modul
