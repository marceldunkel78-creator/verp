...
const VSServiceProductEdit = () => {
  ...
  // Basic Info Form - extended with short/long descriptions DE/EN
  ...
  const fetchProduct = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await api.get(`/service/vs-service/${id}/`);
      ...
      console.error('Error fetching VS-Service product:', error);
  ...
  const handleSave = async () => {
    setSaving(true);
    try {
      await api.patch(`/service/vs-service/${id}/`, formData);
  ...
  const savePrice = async () => {
    try {
      ...
      if (editingPrice.id) {
        await api.put(`/service/vs-service-prices/${editingPrice.id}/`, payload);
      } else {
        await api.post('/service/vs-service-prices/', payload);
      }
  ...
  const deletePrice = async (priceId) => {
    ...
    try {
      await api.delete(`/service/vs-service-prices/${priceId}/`);
      fetchProduct();
    } catch (error) {
  ...
  if (!product) {
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center text-gray-500">Service-Produkt nicht gefunden</div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-6">
        <button
          onClick={() => navigate('/service/vs-service')}
          className="flex items-center text-gray-600 hover:text-gray-900 mb-4"
        >
          <ArrowLeftIcon className="h-5 w-5 mr-2" />
          Zurück zu VS-Service Produkte
        </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="z.B. Service Paket Premium"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                    placeholder="Kurze Beschreibung für Listen/Angebote..."
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500"
                    placeholder="Short description for lists/quotes..."
                  />
                </div>
...
export default VSServiceProductEdit;
